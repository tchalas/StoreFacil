...
/**
 * Servlet implementation class NumberSuppliersList
 */
@WebServlet("/NumberSuppliersList")
public class NumberSuppliersList extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public NumberSuppliersList() {
        super();
