...
/**
 * Servlet implementation class WarehousePage
 */
@WebServlet("/WarehousePage")
public class WarehousePage extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		session.setAttribute("warehousePage", ware);
